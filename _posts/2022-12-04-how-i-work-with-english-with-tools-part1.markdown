...
百聞は一見にしかず、だと思うので、実際にGrammarlyを使ってみましょう。例えばGrammarlyのエディタに私が以前書いた英語の[ブログ]({{site.baseurl}}/2019/10/overlay-technologies-and-me-en/)の冒頭のパラグラフをコピペしてみます。
...
もう一つ例を見てみましょう。こちらは私が以前Grammarlyを通さずに書いた[ブログ]({{site.baseurl}}/2018/01/h323decoder-primer/)記事の例です。
...
今回は文章校正ツールを中心にお話をしました。[次回]({{site.baseurl}}/2022/12/how-i-work-with-english-with-tools-part2/)は「プレイン・イングリッシュ」についてお話ししようと思います。
