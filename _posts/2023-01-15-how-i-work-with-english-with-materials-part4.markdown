...
[前回]({{site.baseurl}}/2023/01/how-i-work-with-english-with-materials-part3/)はドラマを中心に紹介をしました。今回紹介する素材はPodcastです。英語のPodcastはたくさんありますので、網羅的に紹介するのは不可能です。というわけで、私が日々お世話になっているPodcastをいくつか紹介することにしましょう。
...
Podcastについての紹介は以上です。[次回]({{site.baseurl}}/2023/01/how-i-work-with-english-with-materials-part5/)は読み物についてお話をしようと思います。
